...
void procRegistrarEstudiante(){
	...
	lista[contEstudiantes].estado = (lista[contEstudiantes].promFinal>=12)?"Aprobado":"Desaprobado";			
	// Reporte
	cout << endl;
...
void procEstadistico(){
	// Variables
	int contAprobados=0;
	double porcAprobados=0, porcDesaprobados=0, sumaPromedio=0.0;
	double mediaPromedio=0, medianaPromedio=0, dsPromedio=0;
	// Proceso
	for(int i=0; i<contEstudiantes; i++){
